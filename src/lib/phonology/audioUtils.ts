...
const wikimediaMap: Record<string, string> = {
  ...
  'p': '5/51/Voiceless_bilabial_plosive.ogg/Voiceless_bilabial_plosive.ogg.mp3', // Updated path
  'b': '2/2c/Voiced_bilabial_plosive.ogg/Voiced_bilabial_plosive.ogg.mp3',       // Updated path
  ...
  'ɖ': 'd/d2/Voiced_retroflex_stop.oga/Voiced_retroflex_stop.oga.mp3',
  'c': 'e/e6/Voiceless_palatal_plosive.ogg/Voiceless_palatal_plosive.ogg.mp3',
  ...
  'g': '1/12/Voiced_velar_plosive.ogg/Voiced_velar_plosive.ogg.mp3',
  'q': 'c/c5/Voiceless_uvular_plosive.ogg/Voiceless_uvular_plosive.ogg.mp3',
  'ɢ': 'b/b6/Voiced_uvular_plosive.ogg/Voiced_uvular_plosive.ogg.mp3',
  'ʔ': '4/4d/Glottal_stop.ogg/Glottal_stop.ogg.mp3',

  // Nasals
  'm': 'a/a9/Bilabial_nasal.ogg/Bilabial_nasal.ogg.mp3',
  'ɱ': 'e/e9/Labiodental_nasal.ogg/Labiodental_nasal.ogg.mp3',
  ...
  'ɴ': 'e/e3/Uvular_nasal.ogg/Uvular_nasal.ogg.mp3',

  // Fricatives
  'ɸ': '3/31/Voiceless_bilabial_fricative.ogg/Voiceless_bilabial_fricative.ogg.mp3',
  'β': 'b/bc/Voiced_bilabial_fricative.ogg/Voiced_bilabial_fricative.ogg.mp3',
  ...
  // Approximants
  'ʋ': '3/38/Labiodental_approximant.ogg/Labiodental_approximant.ogg.mp3',
  'ɹ': 'a/a0/Alveolar_approximant.ogg/Alveolar_approximant.ogg.mp3',
  ...
  // Laterals
  'ɬ': '4/41/Voiceless_alveolar_lateral_fricative.ogg/Voiceless_alveolar_lateral_fricative.ogg.mp3',
  'ɮ': 'd/d9/Voiced_alveolar_lateral_fricative.ogg/Voiced_alveolar_lateral_fricative.ogg.mp3',
  ...
  'u': 'e/ea/Close_back_rounded_vowel.ogg/Close_back_rounded_vowel.ogg.mp3',
  ...
  'ʊ': 'f/ff/Near-close_near-back_rounded_vowel.ogg/Near-close_near-back_rounded_vowel.ogg.mp3',
  'e': '6/6c/Close-mid_front_unrounded_vowel.ogg/Close-mid_front_unrounded_vowel.ogg.mp3',
  'ø': '5/5d/Close-mid_front_rounded_vowel.ogg/Close-mid_front_rounded_vowel.ogg.mp3',
  'ɘ': '7/71/Close-mid_central_unrounded_vowel.ogg/Close-mid_central_unrounded_vowel.ogg.mp3',
  'ɵ': 'b/b5/Close-mid_central_rounded_vowel.ogg/Close-mid_central_rounded_vowel.ogg.mp3',
  'ɤ': '2/2c/Close-mid_back_unrounded_vowel.ogg/Close-mid_back_unrounded_vowel.ogg.mp3',
  ...
  'ɜ': '0/0a/Open-mid_central_unrounded_vowel.ogg/Open-mid_central_unrounded_vowel.ogg.mp3',
  'ɞ': 'a/a3/Open-mid_central_rounded_vowel.ogg/Open-mid_central_rounded_vowel.ogg.mp3',
  'ʌ': 'd/d9/Open-mid_back_unrounded_vowel.ogg/Open-mid_back_unrounded_vowel.ogg.mp3',
  ...
  'ɐ': '2/22/Near-open_central_vowel.ogg/Near-open_central_vowel.ogg.mp3',
  'a': '6/65/Open_front_unrounded_vowel.ogg/Open_front_unrounded_vowel.ogg.mp3',
  'ɶ': '9/91/Open_front_rounded_vowel.ogg/Open_front_rounded_vowel.ogg.mp3',
  'ɑ': 'e/e5/Open_back_unrounded_vowel.ogg/Open_back_unrounded_vowel.ogg.mp3',
  'ɒ': '5/53/Open_back_rounded_vowel.ogg/Open_back_rounded_vowel.ogg.mp3',
};
